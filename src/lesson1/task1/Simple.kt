 ...
 */
fun main() {
    val thDig = thirdDigit(4258)
    val numRev = numberRevert(12345)
    println("Third digit of 4258 is $thDig\nAnd reversed number of 12345 is $numRev\nI like to code in Kotlin. It's wonderfull!")
}
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg + min /60 + sec / 3600) * Math.PI / 180 // не понимаю, в чем ошибка. сра формулы (
